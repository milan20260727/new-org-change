...
// Permissions is the only table this tool writes to — everything else is read-only by design.
...
module.exports = { fetchSourceRecords, createSourceRecord, updateSourceRecord, deleteSourceRecords, getTenantAccessToken, searchAllRecords };
